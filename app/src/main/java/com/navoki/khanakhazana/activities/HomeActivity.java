...
import com.navoki.khanakhazana.BuildConfig;
import com.navoki.khanakhazana.R;
import com.navoki.khanakhazana.adapters.RecipeListAdapter;
import com.navoki.khanakhazana.database.AppDatabase;
import com.navoki.khanakhazana.database.RecipeListViewModel;
...
import com.navoki.khanakhazana.widget.BakingWidgetProvider;
...
public class HomeActivity extends AppCompatActivity implements OnAdapterClickListener {
    ...
    public void onItemClick(int pos, ImageView imageView) {
        if (isFromSplash) {
            ...
            intent.setAction(AppConstants.ACTION_DATA_UPDATE);
